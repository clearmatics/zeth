...
template<> constexpr size_t bit_utils<0>::hamming_weight() { return 0; }
...
template<size_t X> constexpr size_t bit_utils<X>::hamming_weight()
{
    return (X & 1) + bit_utils<(X >> 1)>::hamming_weight();
}
