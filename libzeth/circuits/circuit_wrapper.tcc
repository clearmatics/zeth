    ...
    TreeDepth>::circuit_wrapper()
{
    ...
    // Populate public_data_hash to represent the joinsplit public data. Skip
    // the first 2 variable (the constant 1 and the hash), and use the
    // following num_public_elements variables.
