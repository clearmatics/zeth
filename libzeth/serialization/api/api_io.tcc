    ...
    const zeth_proto::JoinsplitInput &input)
{
    ...
    bits256 input_spending_ask = get_bits256_from_hexadecimal_str(input.spending_ask());
    bits256 input_nullifier = get_bits256_from_hexadecimal_str(input.nullifier());
    ...
    const libff::G1<ppT> &point)
{
    ...
    std::string x_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.X.as_bigint());
    std::string y_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.Y.as_bigint());
    ...
    const libff::G2<ppT> &point)
{
    ...
    std::string x_c1_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.X.c1.as_bigint());
    std::string x_c0_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.X.c0.as_bigint());
    std::string y_c1_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.Y.c1.as_bigint());
    std::string y_c0_coord =
        "0x" + libsnark_bigint_to_hexadecimal_str<libff::Fq<ppT>>(aff.Y.c0.as_bigint());
