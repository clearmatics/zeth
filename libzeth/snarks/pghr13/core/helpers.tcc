...
void export_verification_key(libsnark::r1cs_ppzksnark_keypair<ppT> keypair)
{
    ...
    std::cout << "\tVerification key in Solidity compliant format:{"
              ...
              << point_g1_affine_to_hexadecimal_str<ppT>(keypair.vk.encoded_IC_query.first)
              << ");" << std::endl;
...
void display_proof(libsnark::r1cs_ppzksnark_proof<ppT> proof)
{
    std::cout << "Proof:"
              ...
              << point_g1_affine_to_hexadecimal_str<ppT>(proof.g_K) << ");" << std::endl;
};
    ...
    boost::filesystem::path path)
{
    ...
    ss << " \"gb1\" :[" << point_g1_affine_to_hexadecimal_str<ppT>(vk.gamma_beta_g1)
       << "],\n";
    ss << " \"gb2\" :[" << point_g2_affine_to_hexadecimal_str<ppT>(vk.gamma_beta_g2)
       << "],\n";
    ss << " \"z\" :[" << point_g2_affine_to_hexadecimal_str<ppT>(vk.rC_Z_g2) << "],\n";

    ss << "\"IC\" :[[" << point_g1_affine_to_hexadecimal_str<ppT>(vk.encoded_IC_query.first)
       << "]";
