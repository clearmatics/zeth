...
TEST(TestPackedAddition, TestPackedAddition1)
{
    ...
    value_left1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("000000000000000A")));
    value_left2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("000000000000000A")));

    // 0A + 0A = 14 in hexa
    value_right1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("0000000000000014")));
...
TEST(TestPackedAddition, TestPackedAddition2)
{
    ...
    value_left1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("3782DACE9D900000")));
    // 0x3782DACE9D900000 = 4ETH
    value_left2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("3782DACE9D900000")));
    ...
    value_right1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("6124FEE993BC0000")));
    // 0x0DE0B6B3A7640000 = 1ETH
    value_right2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("0DE0B6B3A7640000")));
...
TEST(TestPackedAddition, TestPackedAddition3)
{
    ...
    v_pub_in.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("0000000000000010")));
    in_val_note1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("2F0000000000000F")));
    in_val_note2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("0000000000000000")));

    v_pub_out.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("000000000000000B")));
    out_val_note1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("1A00000000000012")));
    out_val_note2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("1500000000000002")));
...
TEST(TestPackedAddition, TestPackedAddition4)
{
    ...
    v_pub_in.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("FA80001400000000")));
    ...
    out_val_note1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("8530000A00000000")));

    // 0x7550000A00000000 = 8.453256543524093952 ETH
    out_val_note2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("7550000A00000000")));
...
TEST(TestPackedAddition, TestPackedAddition5)
{
    ...
    out_val_note2.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("29A2241AF62C0000")));
...
TEST(TestPackedAddition, TestPackedAddition6)
{
    ...
    out_val_note1.fill_with_bits(
        pb, libff::bit_vector(hexadecimal_str_to_binary_vector("3782DACE9D900001")));
