...
template<typename ppT> void generate_test_data()
{
    ...
    cs.add_constraint({
        libsnark::linear_combination<Field>{{{1, 2}, {3, 3}}},
        libsnark::linear_combination<Field>{{{2, 4}, {4, 5}}},
        libsnark::linear_combination<Field>{{{5, 6}, {1, 7}}},
    });
    cs.add_constraint({
        libsnark::linear_combination<Field>{{{2, 7}, {5, 6}}},
        libsnark::linear_combination<Field>{{{1, 5}, {3, 4}}},
        libsnark::linear_combination<Field>{{{4, 3}, {2, 2}}},
    });
