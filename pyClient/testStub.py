...
if __name__ == '__main__':
    ...
    print(ciphertext2)
    print("plaintext1: ")
    print(decrypt(ciphertext1, keystore["Bob"]["AddrSk"]["dk"]))
    print("plaintext2: ")
    print(decrypt(ciphertext1, keystore["Bob"]["AddrSk"]["dk"]))
    try:
        alice_plaintext = decrypt(ciphertext1, keystore["Alice"]["AddrSk"]["dk"])
        print("Alice plaintext: " +  alice_plaintext)
    except:
        print("Alice tried to decrypt a ciphertext of Bob but failed")
