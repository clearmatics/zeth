#ifndef __ZETH_BITS_HPP__
#define __ZETH_BITS_HPP__
...
template<size_t BitLen> std::array<bool, BitLen> binaryAddition(std::array<bool, BitLen> A, std::array<bool, BitLen> B);
