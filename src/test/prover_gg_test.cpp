...
bool TestValidJS2In2Case1(
    ...
    libsnark::r1cs_gg_ppzksnark_verification_key<ppT> vk = keypair.vk;
    bool res = libsnark::r1cs_gg_ppzksnark_verifier_strong_IC<ppT>(vk, ext_proof.get_primary_input(), ext_proof.get_proof());
...
bool TestValidJS2In2Deposit(
    ...
    //libsnark::r1cs_gg_ppzksnark_primary_input<ppT> primary_inputs = .get_primary_input();TODO: use in case move the function
...
TEST(MainTests, ProofGenAndVerifJS2to2) {
    ...
    libsnark::r1cs_gg_ppzksnark_keypair<ppT> keypair = proverJS2to2.generate_trusted_setup();
    bool res = false;
