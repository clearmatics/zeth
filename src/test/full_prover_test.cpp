...
bool Test_ValidJS1In1Out(
    ...
    // Note: We do not care about the commiment value, this is computed inside the circuit, this is not an input!!!
    // TODO: Remove the commitment from the zeth note structure
...
bool Test_InvalidJS1In1Out(
    ...
    char* value_str_out = "2F000000000000FF";
    bits64 value_out_bits64 = get_bits64_from_vector(hexadecimal_str_to_binary_vector(value_str_out));
    ...
    char* outer_k_str_out = "13a067be67971e25bf9e46fb93bb98b91619aba6c383cfcc803d70527a6ba04d";
    char* value_front_padded_zeroes_out = "0000000000000000000000000000000000000000000000002F0000000000000F";
    char* cm_str_out = "7777777725a5844abdae214896d13c376a9aea4bfe4cafbb5572822feb39b8ea"; // wrong hash
    bits256 cm_out_bits256 = get_bits256_from_vector(hexadecimal_digest_to_binary_vector(cm_str_out));
    ...
    bool res = libsnark::r1cs_ppzksnark_verifier_strong_IC<ppT>(vk, primary_inputs, ext_proof.get_proof());
...
TEST(MainTest, ProofGenAndVerif) {
    ...
    res = Test_ValidJS1In1Out(prover, keypair);
    std::cout << "Test 1" << std::endl;
    ASSERT_TRUE(res);

    try {
        res = Test_InvalidJS1In1Out(prover, keypair);
        std::cout << "Test 2" << std::endl;
        ASSERT_FALSE(res);
    } catch (const std::invalid_argument& ia) {
        std::cerr << "Expected invalid argument (Joinsplit balance constraint violated: Error thrown and proof generation aborted): " << ia.what() << '\n';
    }

    res = Test_ValidJS1In1Out1PubVal(prover, keypair);
