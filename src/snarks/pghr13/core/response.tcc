    ...
    extended_proof<ppT> &ext_proof, ExtendedProof *message)
{
    ...
    HexadecimalPointBaseGroup1Affine *a_p =
        new HexadecimalPointBaseGroup1Affine();
    HexadecimalPointBaseGroup2Affine *b =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    HexadecimalPointBaseGroup1Affine *b_p =
        new HexadecimalPointBaseGroup1Affine();
    HexadecimalPointBaseGroup1Affine *c =
        new HexadecimalPointBaseGroup1Affine();
    HexadecimalPointBaseGroup1Affine *c_p =
        new HexadecimalPointBaseGroup1Affine();
    HexadecimalPointBaseGroup1Affine *h =
        new HexadecimalPointBaseGroup1Affine();
    HexadecimalPointBaseGroup1Affine *k =
        new HexadecimalPointBaseGroup1Affine();
    ...
    b->CopyFrom(
        FormatHexadecimalPointBaseGroup2Affine(proofObj.g_B.g)); // in G2
    ...
    R1csPpzksnarkExtendedProof *r1csPpzksnarkExtendedProof =
        message->mutable_r1csppzksnarkextendedproof();
...
{
    HexadecimalPointBaseGroup2Affine *a =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    HexadecimalPointBaseGroup1Affine *b =
        new HexadecimalPointBaseGroup1Affine(); // in G1
    HexadecimalPointBaseGroup2Affine *c =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    HexadecimalPointBaseGroup2Affine *g =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    HexadecimalPointBaseGroup1Affine *gb1 =
        new HexadecimalPointBaseGroup1Affine(); // in G1
    HexadecimalPointBaseGroup2Affine *gb2 =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    HexadecimalPointBaseGroup2Affine *z =
        new HexadecimalPointBaseGroup2Affine(); // in G2
    ...
    gb1->CopyFrom(
        FormatHexadecimalPointBaseGroup1Affine(vk.gamma_beta_g1)); // in G1
    gb2->CopyFrom(
        FormatHexadecimalPointBaseGroup2Affine(vk.gamma_beta_g2));   // in G2
    ...
    // See:
    // https://stackoverflow.com/questions/33960999/protobuf-will-set-allocated-delete-the-allocated-object
    R1csPpzksnarkVerificationKey *r1csPpzksnarkVerificationKey =
        message->mutable_r1csppzksnarkverificationkey();
