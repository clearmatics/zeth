    ...
    a2(a2), b2(b2), c2(c2), d2(d2)
{
    ...
    a1_1_gadget.reset(new double_bit32_sum_eq_gadget<FieldT>(pb, a, b, a1_temp));
    a1_2_gadget.reset(new double_bit32_sum_eq_gadget<FieldT>(pb, a1_temp, x, a1));
    ...
    a2_1_gadget.reset(new double_bit32_sum_eq_gadget<FieldT>(pb, a1, b1, a2_temp));
    a2_2_gadget.reset(new double_bit32_sum_eq_gadget<FieldT>(pb, a2_temp, y, a2));
...
template<typename FieldT>
void g_primitive<FieldT>::generate_r1cs_constraints(){
    // 262 constraints (4 * 32 (xor) + 4 * 33 (add true) + 2 * 1 (add false))
    a1_1_gadget->generate_r1cs_constraints(false); // we do not check the booleaness of this temp variable
    ...
    a2_1_gadget->generate_r1cs_constraints(false); // we do not check the booleaness of this temp variable
...
template<typename FieldT>
void g_primitive<FieldT>::generate_r1cs_witness(){
