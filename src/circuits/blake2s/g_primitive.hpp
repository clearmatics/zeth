...
class g_primitive : public libsnark::gadget<FieldT> {
private:
    ...
    std::shared_ptr<xor_rot_gadget<FieldT> > d_xor_gadget;
    std::shared_ptr<xor_rot_gadget<FieldT> > b_xor_gadget;
    std::shared_ptr<xor_rot_gadget<FieldT> > d1_xor_gadget;
    std::shared_ptr<xor_rot_gadget<FieldT> > b1_xor_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > a1_1_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > a1_2_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > c1_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > a2_1_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > a2_2_gadget;
    std::shared_ptr<double_bit32_sum_eq_gadget<FieldT> > c2_gadget;

public:
    g_primitive(libsnark::protoboard<FieldT> &pb,
