...
function createZethNote(randomness, recipientApk, value) {
	return {
		apk: recipientApk,
		value: value,
		rho: randomness.rho,
...
function computeCommitment(zethNote) {
...
function generateApkAskKeypair() {
