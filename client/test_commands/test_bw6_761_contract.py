...
def test_bw6_ecadd(bw6_instance: Any) -> None:
    """
    Check that [6] == [2] + [4]
    """
...
def test_bw6_ecmul(bw6_instance: Any) -> None:
    """
    Check that [-8] == -2 * [4]
    """
...
def test_bw6_ecpairing(bw6_instance: Any) -> None:
    """
