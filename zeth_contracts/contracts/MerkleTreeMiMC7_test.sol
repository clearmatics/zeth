...
import "./BaseMerkleTree_test.sol";
import "./MiMC7.sol";
...
// default value.
contract MerkleTreeMiMC7_test is BaseMerkleTree_test
{
    // Code of the MerkleTreeMiMC7 contract
    uint256 constant MASK_LS_BIT = ~uint256(1);

    constructor(uint256 treeDepth) BaseMerkleTree_test(treeDepth) public
    {
        initializeTree();
    }
